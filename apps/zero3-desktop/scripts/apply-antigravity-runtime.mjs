...
const windowSurface = String.raw`    zero3Antigravity: {
      ...
      startTurn: (request: { logicalSessionId: string; projectId?: string | null; cwd: string; prompt: string; model?: string | null; effort?: 'low' | 'medium' | 'high' | null; taskId?: string | null; contextVersion?: number | null }) => Promise<{ turnId: string }>
