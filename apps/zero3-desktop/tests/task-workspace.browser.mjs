...
try {
  ...
  console.log('Task browser acceptance passed: create, persist/reload, assign/bind, progress/artifact, reject/approve, dependency release, seven tabs, search/filters, human/block, cancelled dependency, disconnect.')
} finally {
  await browser?.close()
