...
const STEP_TRANSITIONS: Readonly<Record<ExecutionStepStatus, readonly ExecutionStepStatus[]>> = {
  ...
  dispatching: ['running', 'verifying', 'waiting_human', 'blocked', 'outcome_unknown', 'failed', 'cancelled'],
  ...
  fix_required: ['dispatching', 'running', 'verifying', 'waiting_human', 'blocked', 'failed', 'cancelled'],
