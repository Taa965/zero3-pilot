...
- all 20 oversized synthetic results are explicitly D1-backed / recovery-eligible
...
D2B fails closed when the frozen D1 recovery reference is absent. The benchmark therefore does not model unsafe pruning of unrecoverable historical output just to improve the token number.
...
- number of oversized results marked recovery-eligible.
