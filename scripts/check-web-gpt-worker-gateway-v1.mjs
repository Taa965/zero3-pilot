...
requireText(remoteNode, 'this.client.leaseWorkerRpc(25, capabilities)', 'Local Zero3 must use outbound HTTPS long-polling for bounded Worker/Skill RPC capabilities.')
...
requireText(remoteClient, "capabilities: string[] = ['worker-protocol-v1']", 'Worker RPC leasing must default to the bounded Worker capability.')
